...
- หลังแก้ไฟล์เสร็จทุกครั้ง ให้หยุดแล้วถามผมว่า "ทดสอบในเครื่องผ่านหรือยัง 
  ถ้าผ่านแล้วจะ push ขึ้น GitHub เลยไหม" ห้าม push เองโดยไม่ถาม
- ก่อน commit ทุกครั้ง ให้รัน git status แล้วแสดงผลให้ผมดูก่อน 
  ถ้าเห็นไฟล์ .env อยู่ในรายการ ให้หยุดทันทีและเตือนผม
- ข้อความ commit ให้เขียนสั้น ๆ เป็นภาษาไทยว่าแก้อะไร งานเดียวต่อหนึ่ง commit
- ห้ามใช้ git push --force เด็ดขาด
- โปรเจกต์นี้ต่อ Auto-Deploy กับ Render อยู่ push ขึ้น main = ขึ้นระบบจริงทันที 
  ให้เตือนผมทุกครั้งก่อน push